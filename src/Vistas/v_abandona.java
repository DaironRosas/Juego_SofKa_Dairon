...
public class v_abandona extends javax.swing.JFrame {
    ...
    public v_abandona() {
        ...
        initComponents();
        v_principal_Juego puntos = new v_principal_Juego();
        v_inicial nombre = new v_inicial();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_abandona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                v_abandona mostrar = new v_abandona();
